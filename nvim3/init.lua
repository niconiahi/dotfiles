...
vim.keymap.set('n', ']E', function()
  ...
  vim.cmd 'cnext' -- jump to the next item in the quickfix list
end, { desc = 'Jump to next diagnostic across files' })

-- Explorer
vim.keymap.set('n', '<leader>x', ':Explore<Enter>', { desc = 'Open explorer' })
...
require('lazy').setup {
  ...
  --    require('Comment').setup({})
  {
    ...
    ft = 'blade', -- This will only load the plugin for Blade files
  },
